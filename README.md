...
* Setting width of modal to 70%, of viewport, allows that modest-sized top space plus a header (fixed in height, for minimum font-size) to show above, while also allowing the video control bar to show below, within the viewport on monitors as "squat" as my laptop (1366x768).
